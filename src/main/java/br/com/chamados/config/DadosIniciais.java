package br.com.chamados.config;

import br.com.chamados.model.*;
import br.com.chamados.repository.*;
...
public class DadosIniciais implements CommandLineRunner {
    ...
    /** Precisa ser igual ao default de app.admin.senha no application.properties. */
    private static final String SENHA_PADRAO = "admin231@@";
